...
const OrderTitle = ({ record }: OrderTitleProps): React.ReactElement | null => {
...
const Spacer = (): React.ReactElement => <Box m={1}>&nbsp;</Box>;

// eslint-disable-next-line @typescript-eslint/no-explicit-any
const OrderForm = (props: any): React.ReactElement => {
  const translate = useTranslate();
  return (
    <FormWithRedirect
      {...props}
...
const OrderEdit = (props: EditProps): React.ReactElement => {
