...
const Aside = ({ record, basePath }: AsideProps): ReactElement => {
...
const EventList = ({ record, basePath }: EventListProps): ReactElement => {
    ...
    <>
      ...
      <Stepper orientation="vertical" classes={{ root: classes.stepper }}>
        {events.map((event) => (
          ...
          >
            <StepLabel
              StepIconComponent={(): ReactElement => {
                const Component =
...
const Order = ({ record, basePath }: OrderProps): ReactElement | null => {
  const translate = useTranslate();
  return record ? (
    <>
...
const Review = ({ record, basePath }: ReviewProps): ReactElement | null => {
